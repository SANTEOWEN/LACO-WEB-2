        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                Please fill in the required field.
                                            ...
                                            $verify_query = mysqli_query($con, "SELECT section FROM tbsection WHERE section='$section'");

                                            if (mysqli_num_rows($verify_query) != 0) {
                                                echo '<div class="alert alert-danger" role="alert">
                    Section already exists. Please choose a different one.
                  </div>';
                                            } else {
                                                $sql = mysqli_query($con, "INSERT INTO tbsection(section) 
                    VALUES('$section')") or die("Error Occurred");
