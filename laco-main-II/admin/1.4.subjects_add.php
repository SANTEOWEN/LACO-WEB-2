                        ...
                        <div class="card-body p-3" style="height: 450px;">
                            <div class="container">
                                <div class="text-center mb-4">
                                    ...
                                    if (isset($_POST['subject-save'])) {
                                        $subjectcode = $_POST['subjectcode'];
                                        $subjectname = $_POST['subjectname'];
                                        $prof = $_POST['Prof'];

                                        if (empty($subjectcode) || empty($subjectname) || empty($prof)) {
                                            echo '<div class="alert alert-danger" role="alert">
                                                     Please fill in all the required fields.
                                                 </div>';
                                        } else {

                                            $verify_query = mysqli_query($con, "SELECT subjectcode FROM tbsubjects WHERE subjectcode='$subjectcode'");
                                            if (mysqli_num_rows($verify_query) != 0) {
                                                ...
                                                $sql = mysqli_query($con, "INSERT INTO tbsubjects(subjectcode,subjectname,prof) 
                                VALUES('$subjectcode','$subjectname','$prof')") or die("Error Occured");
                            ...
                            <div class="">
                                <form class="justify-content-start allign-items-center" action="" method="post">
                                    ...
                                    <div class="column">
                                        ...
                                        <div class="col mt-2">
                                        <label class="form-label">Proffessor</label>
