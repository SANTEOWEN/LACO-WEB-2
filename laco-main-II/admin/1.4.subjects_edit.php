                        ...
                        <div class="card-body p-3" style="height: 400px;">
                            <div class="container">
                                <div class="text-center mb-4">
                                    ...
                                    $id = $_GET['id'];
                                    $sql = "SELECT * FROM tbsubjects WHERE id=$id";
                                    ...
                                    if (isset($_POST['update'])) {
                                        ...
                                        $prof = $_POST['prof'];
                                        // Update query
                                        $update_sql = "UPDATE tbsubjects
                                          SET subjectcode='$subjectcode', subjectname='$subjectname', prof='$prof'  WHERE id=$id";

                                        mysqli_query($con, $update_sql);

                                        if (mysqli_affected_rows($con) > 0) {
                                            header("Location: index.php?msg_admin=Subject Data Changed Complete!");
                                            exit;
                                        } else {
                                    ...
                                    <div class="column">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" name="subjectcode"
                                                value="<?php echo $row['subjectcode'] ?>">
                                        </div>
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <label class="form-label">Profressor</label>
                                            <input type="text" class="form-control" name="prof"
                                                value="<?php echo $row['prof'] ?>">
                                        </div>
                                        <div class="mt-4">
