                ...
                <div class="tabs-list">
                    <ul class="sidebar-nav nav-pills">
                        <li class="sidebar-item test_3 active" data-tc="tab_items_9">
                            <a href="#" onclick="resetWebsite()" class="sidebar-link">
                        ...
                        <li class="sidebar-item" id="v-pills-tab" role="tablist">
                            ...
                            <ul id="pages" class="sidebar-dropwn list-unstyled collapse" data-bs-parent="#sidebar">
                                ...
                                <li class="sidebar-item test_2" data-tc="tab_9">
                                    <a class="sidebar-link"><i class="uil uil-head-side test-1"></i></i>Registrar</a>
                                </li>
                                ...
                                <li class="sidebar-item test_2" data-tc="tab_3">
                                    <a class="sidebar-link" id="tab3"><i
                                            class="uil uil-user-plus test-1"></i>Student</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item test_3" data-tc="tab_8">
                            <a href="#" class="sidebar-link collapsed hover-me" aria-expanded="false">
