        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                        ...
                        <div class="card-body p-3" style="height: 500px;">
                            <div class="container">
                                <div class="text-center mb-4">
                                    <h3>Add Grade</h3>
                                    <p>change forms To add grade!</p>

                                    <?php
                                    include("../config/config.php");

                                    $id = $_GET['id'];
                                    $sql = "SELECT * FROM tbgrades WHERE id=$id";
                ...
                Please fill in all required fields.
                                            ...
                                            $sql = mysqli_query($con, "UPDATE tbgrades SET grades='$grades' WHERE id=$id");
                            ...
                            <form class="justify-content-start allign-items-center" action="" method="post">
                                <div class="column">
                                    ...
                                    <div class="col mt-3">
                                        ...
                                        <input type="text" class="form-control" name="Grades"
                                            value="<?php echo $row['grades'] ?>">
                                    </div>

                                    <div class="mt-3">
                                        <button type="submit" class="btn btn-success" name="new-class">Update
                                            Grades</button>
