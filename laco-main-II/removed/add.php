        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                                ...
                                <div class="card-body p-0 d-flex flex-fill">
                                    <div class="row g-0 w-100">
                                        <div class="col-6">
                                            <div class="p-3 m-1">
                                                <h4>Add Data</h4>
                                                <p class="mb-0">For an accounts</p>
                                            </div>
                                        </div>
                    ...
                    <!--Dashboard-->
                    <!-- add data variable for each class -->
                    <div class="tab_item card border-0 crud-button" id="tab_items_1">
                        ...
                        <?php
                            ...
                            $sql = "INSERT INTO `tbuser`(`Lastname`, `Firstname`, `Middlename`, `Birthday`, `Email`, `Password`,) VALUES ('$last_name','$first_name','$middle_name','$birthdate','$email','$password')";
