            ...
            <div class="h-100">
                ...
                <div class="tabs-list">
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item test_3" data-tc="tab_1">
                        ...
                        <li class="sidebar-item test_3" data-tc="tab_2">
                            <a href="#" class="sidebar-link collapsed hover-me" onclick="handleSubjectFilterClick()" aria-expanded="false">
                        ...
                        <div class="card-header">
                            ...
                            <div class="row d-flex flex-row-reverse">
                                <form action="" method="GET" id="filterForm">
                                    <div class="row">
                                        <div class="col-3 mt-3">
                                            <input type="text" name="profN" class="form-control" readonly value="<?php
                                            // Fetch section names from the database
                                            $user_namer = $_SESSION['user_fullname'];
                                            ...
                                            while ($profRow = mysqli_fetch_assoc($sectionResult)) {
                                                if ($profRow['prof'] == $user_namer) {
                                                    $professorValue = $profRow['prof'];
                                                    break;
                                                }
                                            }
